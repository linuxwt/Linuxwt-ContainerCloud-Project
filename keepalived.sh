...
if [ $ip == "192.168.0.144" ];then
    sed -i 's/192.168.0.143/192.168.0.144/g' /etc/keepalived/keepalived.conf
    ...
    sed -i 's/192.168.0.143/192.168.0.145/g' /etc/keepalived/keepalived.conf
